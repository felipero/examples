                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="modelo"><g:message code="carro.modelo.label" default="Modelo" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: carroInstance, field: 'modelo', 'errors')}">
                                    <g:textField name="modelo" value="${carroInstance?.modelo}" />
                                </td>
                            </tr>
